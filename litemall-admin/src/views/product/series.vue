<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button v-permission="['POST /admin/series/create']" class="filter-item" type="primary" icon="el-icon-edit" @click="handleCreate">添加</el-button>
    </div>

    <!-- 查询结果 -->
    <el-table v-loading="listLoading" :data="list" element-loading-text="正在查询中。。。" border fit highlight-current-row row-key="id">

      <el-table-column align="center" label="系列ID" prop="id"/>

      <el-table-column align="center" label="系列名" prop="name"/>

      <el-table-column align="center" property="iconUrl" label="系列图标">
      ...
      <el-table-column align="center" label="操作" width="200" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-permission="['POST /admin/series/update']" type="primary" size="mini" @click="handleUpdate(scope.row)">编辑</el-button>
          <el-button v-permission="['POST /admin/series/delete']" type="danger" size="mini" @click="handleDelete(scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
import { listSeries, listCatL1, createSeries, updateSeries, deleteSeries } from '@/api/series'
